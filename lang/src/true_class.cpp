...
std::shared_ptr<uva::lang::structure> uva::lang::true_class::create()
{
    ...
    TrueClass->methods = {
        {"is_present", uva::lang::method("is_present", method_storage_type::instance_method, {}, [TrueClass](std::shared_ptr<uva::lang::object> object, std::vector<std::shared_ptr<uva::lang::object>> params) {
