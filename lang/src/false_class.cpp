...
std::shared_ptr<uva::lang::structure> uva::lang::false_class::create()
{
    ...
    FalseClass->methods = {
        {"is_present", uva::lang::method("is_present", method_storage_type::instance_method, {}, [FalseClass](std::shared_ptr<uva::lang::object> object, std::vector<std::shared_ptr<uva::lang::object>> params) {
        ...
        {"||", uva::lang::method("||", method_storage_type::instance_method, {"other"}, [FalseClass](std::shared_ptr<uva::lang::object> object, std::vector<std::shared_ptr<uva::lang::object>> params) {
            return params[0]->cls->methods["is_present"].function(params[0], {});
        })},
    };
